...
Info about tool goes here.

## Usage

Info generated by typer goes here.

'''
typer {{cookiecutter.package_name}}.app utils docs --name awesome-cli --output help.md
'''
...
ake a end user focused note of the change in the folder.
